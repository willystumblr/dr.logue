...
class ZerothSpectrogramParser(AudioParser):
    """
    ...
    def __init__(
        ...
        super(ZerothSpectrogramParser, self).__init__(dataset_path)
    ...
    def parse_audio(self, dataset, augment_method: int) -> Tensor:
        """
        Parses audio.
        ...
        """
        signal = dataset['audio']['array'] # already converted to np.ndarray
        ...
        if augment_method == ZerothSpectrogramParser.SPEC_AUGMENT:
