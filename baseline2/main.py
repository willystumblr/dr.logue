...
if __name__ == '__main__':
    ...
    args.add_argument('--warmup_steps', type=int, default=1800)
    args.add_argument('--decay_steps', type=int, default=1800)
    ...
    args.add_argument('--patience', type=int, default=1)
    args.add_argument('--lr_patience', type=int, default=50)
